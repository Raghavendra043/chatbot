...
function App() {
  ...
  return (
    ...
    >
      ...
      <label style={{position:"fixed", top:"2px", opacity:"70%", right:"20px"}}>by Raghavendra</label>
      <label style={{position:"fixed", top:"20px", opacity:"70%",right:"20px",zIndex:"100"}}>Brance Task</label>
